          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full bg-blue-900 text-white py-3 px-4 rounded-lg hover:bg-blue-800 transition duration-200 font-medium"
                >
                  Kirim Pesan
                </button>
              </form>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {locations.map((location, index) => (
              ...
              >
                ...
                <button className="w-full mt-4 bg-blue-900 text-white py-2 rounded-lg hover:bg-blue-800 transition duration-200">
                  Lihat Detail
                </button>
              </div>
            ))}
