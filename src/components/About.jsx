  ...
  const team = [
    {
      ...
      image: "/assets/placeholder_profile.png",
      ...
      <section className="relative bg-orange-400 text-white py-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <h1 className="text-4xl md:text-5xl font-extrabold mb-6 leading-tight">
            Tentang{" "}
            <span className="underline decoration-white/50">GoBeng</span>
          </h1>
          <p className="text-xl md:text-2xl max-w-3xl mx-auto text-orange-100 animate-fade-in-up">
            Platform bengkel digital yang menghubungkan Anda dengan bengkel
            terpercaya di seluruh Indonesia. Kami hadir untuk memberikan
            pengalaman layanan otomotif yang cepat, mudah, dan terpercaya.
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {team.map((member, index) => (
              <div key={index} className="text-center">
                <img
                  src={member.image || "/assets/placeholder_profile.png"}
                  alt={member.name}
