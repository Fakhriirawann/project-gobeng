            ...
            >
              ...
              <div className="relative container mx-auto px-4 h-full flex items-center z-10 -mt-20">
                <div className="max-w-2xl">
                  ...
                  <Link
                    to={slide.ctaLink}
                    className="bg-orange-400 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-orange-300 transition duration-300 inline-block animate-fade-in btn-hover"
                  >
                    {slide.cta}
                  </Link>
                </div>
